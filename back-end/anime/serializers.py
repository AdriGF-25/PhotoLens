...
class PortadaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Portada
        fields = ["id", "manga", "imagen", "titulo_busqueda", "fuente", "es_principal", "creada_at"]
        extra_kwargs = {
            "creada_at": {"read_only": True},
        }
...
class MangaDetailSerializer(serializers.ModelSerializer):
    ...
    portadas = PortadaSerializer(many=True, read_only=True)
    portada = serializers.SerializerMethodField()
    total_capitulos = serializers.SerializerMethodField()
    categoria = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            "portada_local", "portadas", "generos", "generos_detalle", "categoria",
